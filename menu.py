...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_selection = input("Enter the menu item number of the menu item you would like: ")
            ...
            if menu_selection.isnumeric():
                ...
                if menu_selection in menu_items.keys(): #rework this section to search list for number
                    ...
                    menu_item_quantity = input(f"Enter a quantity of {selected_item_name}(s): ")

                    # Check if the quantity is a number, default to 1 if not
                    if (menu_item_quantity.isnumeric()):
                    ...
                    print("Invalid input: number is not a menu item number")
...
for i in range(0, len(order)):
    ...
    print(f"{item_name}{item_spaces}|{price_spaces}${price} | {quantity}")
